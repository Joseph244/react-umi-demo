// @ts-nocheck
/**
 * Base on https://github.com/umijs/D:/0ZZF/1code/umi-demo/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from 'D:/0ZZF/1code/umi-demo/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from 'D:/0ZZF/1code/umi-demo/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from 'D:/0ZZF/1code/umi-demo/node_modules/@ahooksjs/use-request/lib/types';
